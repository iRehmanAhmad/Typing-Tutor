    ...
    return (
        <div className="relative">
            ...
            >
                ...
                />
                <span className="text-[11px] font-black uppercase tracking-widest text-text-muted">Appearance</span>
            </button>
                    ...
                    <>
                        ...
                        >
                            <div className="px-3 py-2 border-b border-border mb-2">
                                <p className="text-[11px] font-black text-text-muted uppercase tracking-tighter leading-none">Choose Theme</p>
                            </div>
