                    ...
                    >
                        ...
                        <div className="w-full xl:w-[280px] 2xl:w-[300px] flex-shrink-0 space-y-6">
                            ...
                            <div className="bg-gradient-to-br from-bg-secondary/80 to-bg-secondary/30 border border-border rounded-3xl p-6 min-h-[300px] relative overflow-hidden group shadow-xl">
                                ...
                                <div className="absolute top-3 right-3 text-[7px] font-black text-white/20 uppercase tracking-[.3em] border border-white/5 px-2 py-0.5 rounded backdrop-blur-sm">
                                    Sponsored Intel
                                </div>
                                ...
                                <div className="space-y-4 relative z-10">
                                    ...
                                    <button className="w-full py-2 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all hover:scale-[1.02] active:scale-95">
                                        Initialize Recon
                                    </button>
                                </div>
