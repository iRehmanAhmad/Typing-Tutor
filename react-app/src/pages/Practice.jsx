...
const AdUnit = ({ className = "" }) => (
    <div className={`relative overflow-hidden bg-bg-secondary border border-border/40 rounded-3xl p-4 flex items-center justify-center min-h-[250px] ${className}`}>
        <div className="absolute top-2 left-4 flex items-center gap-2">
            <span className="text-[11px] font-black uppercase tracking-[0.2em] text-text-muted opacity-40">Sponsored</span>
        </div>
...
const PracticeView = ({ isVisible = true }) => {
    ...
    const zenContent = [
        ...
        // Classics
        { id: 'gibson', title: '📚 Neuromancer (Gibson)', category: 'story', content: "The sky above the port was the color of television, tuned to a dead channel. It was not that it was a dark and stormy night. It was not like the other days, where the sun shone bright and the birds sang. This was a day of reckoning." },
                    ...
                    <div className="max-w-5xl mx-auto mt-8 border border-border/30 rounded-2xl p-4 bg-bg-secondary/30 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] text-text-muted">Learn new skills with our training partners.</p>
                            </div>
                        </div>
                        <button className="px-4 py-2 bg-text-primary text-bg-primary text-[11px] font-black uppercase tracking-widest rounded-lg">
                            Open
                        </button>
                    </div>
                </div>
                ...
                >
                        ...
                        <div className="flex justify-between items-center bg-bg-secondary/50 p-4 rounded-2xl border border-border transition-all animate-in fade-in slide-in-from-top-2 relative">
                            ...
                            {mode === 'active_zen' && (
                                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20 w-64">
                                    <select
                                        ...
                                        className="w-full bg-bg-primary/80 backdrop-blur-sm border border-border/50 text-[11px] font-black uppercase tracking-widest rounded-lg px-4 py-2 outline-none focus:border-accent focus:text-accent cursor-pointer hover:bg-bg-secondary transition-colors text-left shadow-lg truncate appearance-none"
                            ...
                            <div className="flex gap-6">
                                <div className="text-right">
                                    <p className="text-[11px] font-black text-text-muted uppercase">Velocity</p>
                                    <p className="text-xl font-black text-accent">{currentWPM} <span className="text-xs text-text-muted">WPM</span></p>
                                </div>
                                {mode !== 'active_zen' && (
                                    <div className="text-right">
                                        <p className="text-[11px] font-black text-text-muted uppercase">Time</p>
                    ...
                    <div className="w-[300px] flex-shrink-0 hidden xl:block">
                        ...
                        <div className="mt-4 text-center">
                            <button className="text-[11px] font-bold text-text-muted uppercase hover:text-accent transition-colors">
                                Remove Ads (Premium)
                            </button>
                        </div>
                    </div>
