...
const ThreatNeutralization = ({ onAbort, isActive = true }) => {
    const { user } = useAuth();
    ...
    // Derived Wave State
    const wave = Math.floor(score / 1500) + 1;
        ...
        const moveWords = () => {
            setActiveWords(prev => {
                ...
                if (breached) {
                    ...
                    // Check if matched word was lost
                    const currInput = currentInputRef.current;
                    if (currInput && !next.some(w => w.word.startsWith(currInput))) {
                        setInput('');
                    }
                }
                return next;
    ...
    }, [gameState]); // Removed wave/score deps as they are not needed for movement logic
            ...
            <div className="flex justify-between items-center bg-bg-secondary/50 p-4 rounded-2xl border border-border mt-2 backdrop-blur-md relative z-20">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[11px] bg-purple-500/20 text-purple-400 px-2 py-0.5 rounded border border-purple-500/30 font-black">WAVE_{wave}</span>
                        </div>
                ...
                <div className="flex gap-12">
                    <div className="text-right">
                        <p className="text-[11px] font-black text-text-muted uppercase mb-1">Mainframe Shields</p>
                    ...
                    <div className="text-right min-w-[80px]">
                        <p className="text-[11px] font-black text-text-muted uppercase">Tactical Score</p>
