            ...
            <div className="p-6 flex-1 flex flex-col relative z-10">
                <div className="flex justify-between items-start mb-4">
                    <div className="flex items-center gap-2">
                        <div className="bg-bg-tertiary/50 border border-white/5 px-3 py-1 rounded-lg text-[11px] font-black uppercase tracking-widest text-text-muted">
                            Level {index + 1}
                        </div>
                        {isStarted && !isLocked && (
                            <div className="bg-accent/10 border border-accent/20 px-2 py-1 rounded-lg text-[11px] font-black uppercase tracking-widest text-accent">
                                {progress}%
                            </div>
                        )}
                    </div>
                ...
                <div className="space-y-3">
                    ...
                    <button
                        ...
                        disabled={isLocked}
                        className={`
                            w-full py-4 rounded-xl font-black uppercase tracking-[0.2em] text-[11px] transition-all
            ...
            <div className="text-center space-y-2 pt-0 pb-0 relative z-10 w-full max-w-4xl mx-auto">
                ...
                <div className="relative z-10 flex flex-col items-center">
                    <motion.div
                        initial={{ opacity: 0, y: -20 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent/5 border border-accent/20 text-accent text-[11px] font-black uppercase tracking-[0.3em] mb-2"
                    >
