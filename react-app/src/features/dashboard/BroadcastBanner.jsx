            ...
            >
                <div className="bg-accent/10 border-l-4 border-accent p-4 rounded-r-2xl flex items-center gap-4 relative">
                    ...
                    <div className="flex-1">
                        <p className="text-[11px] font-black text-accent uppercase tracking-widest mb-0.5">Global System Alert</p>
                    ...
                    <div className="absolute right-4 top-1/2 -translate-y-1/2 opacity-20 hover:opacity-100 transition-opacity cursor-default">
                        <span className="text-[11px] font-black uppercase text-accent border border-accent/30 px-2 py-0.5 rounded">Live Stream</span>
                    </div>
                </div>
            </motion.div>
        </AnimatePresence>
